...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                    options=[
                                        ...
                                        {'label': 'Vandenberg Air Force Base', 'value': 'VAFB SLC-4E'},
...
def pie_update(site_dropdown):
    if site_dropdown == 'ALL':
        data  = spacex_df[spacex_df['class'] == 1]
        fig = px.pie(
                data,
                names = 'Launch Site',
                title = 'Site Distribution of Successful Launches'
            )
    else:
        ...
        fig = px.pie(
                data,
                names = 'class',
                title = 'Launch Success Rate for Site ' + site_dropdown,
            )
    return fig
...
def scatter_update(site_dropdown, payload_slider):
    ...
    if (site_dropdown == 'ALL'):
        ...
        fig = px.scatter(
                ...
                x = "Payload Mass (kg)",
                y = "class",
                title = 'Success Rate by Payload Mass for site '+ site_dropdown,
                color = "Booster Version Category"
            )
    return fig
